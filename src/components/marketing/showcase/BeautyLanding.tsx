...
const PRODUITS = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1608248597359-577e9e4f21db?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: 'p2',
    name: 'Élixir Éclat',
              ...
              >
                <div>
                  ...
                  <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-white mb-6">
                    ...
                    />
                    <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-[#2B2520]/90 text-white text-[9px] font-bold uppercase tracking-widest">
                      {prod.tag}
                    </div>
                  </div>
