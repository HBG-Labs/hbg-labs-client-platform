  ...
  return (
    <div className="w-full bg-[#FAF8F5] text-[#2D2A26] font-sans antialiased text-[11px] sm:text-[12px] leading-snug">
      ...
      <div className="h-8 sm:h-9 px-4 sm:px-6 bg-[#FAF8F5]/90 border-b border-[#E8E4DC] flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-4 text-[9px] uppercase tracking-widest text-[#6B655C] font-medium">
          <span>Rituels</span>
          <span>Soins</span>
          <span>Boutique</span>
          <span>Contact</span>
      ...
      <div className="p-4 sm:p-6 grid grid-cols-12 gap-4 items-center">
        ...
        <div className="col-span-7 pr-2">
          ...
          <h4 className="font-serif text-[15px] sm:text-[18px] lg:text-[20px] font-medium text-[#2D2A26] leading-tight">
        ...
        <div className="col-span-5 relative aspect-[4/3] rounded-xl overflow-hidden shadow-md border border-[#E8E4DC]">
          <img
            src="/images/showcase/soie-et-terre.jpg"
            alt="Soie & Terre Soins"
            className="w-full h-full object-cover object-[center_35%]"
          />
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-2 text-white">
            <p className="text-[8px] font-medium">Soin Signature Hibiscus & Coco</p>
  ...
  return (
    <div className="w-full bg-[#121316] text-[#F4F5F7] font-sans antialiased text-[11px] sm:text-[12px] leading-snug">
      ...
      <div className="p-4 sm:p-6 grid grid-cols-12 gap-4 items-center">
        ...
        <div className="col-span-5 relative aspect-[4/3] rounded-xl overflow-hidden shadow-md border border-[#2A2E38]">
          <img
          ...
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2 text-white">
            <p className="text-[8px] font-bold text-white uppercase">Parc Engins Propre</p>
